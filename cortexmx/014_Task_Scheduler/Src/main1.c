...
/******************************************************************************************/
/*                           This is the First Code for Scheduler                          */
/******************************************************************************************/
...
void task4_handler(void);  // Task 4 of the application
...
void init_task_stack(void)
{
	...
	for(int i=0; i<MAX_TASKS; i++)
	{
		...
		*pPSP = 0xFFFFFFFD;
		...
		psp_of_tasks[i] = (uint32_t)pPSP;  // psp_of_tasks is pointing to the last content of the stack
